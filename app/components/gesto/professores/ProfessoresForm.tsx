...
const ProfessoresForm = ({ professor, onChange, onSubmit, onDelete, onCancel, newProfessor }) => {
    return (
        <form onSubmit={onSubmit}>
            <div className="grid gap-4 py-4">
                {['name', 'schoolDisciplines', 'contact', 'phoneNumber', 'status'].map((field) => (
            ...
            <div className="flex justify-center gap-4">
                { newProfessor && (<Button variant="destructive" onClick={onDelete}>Excluir</Button>)}
